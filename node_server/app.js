...
const arduinoSerial = new SerialPort({ path: 'COM7', baudRate: 38400 });
...
httpServer.get('/', (req, res) => {
  res.send(`Dernières données reçues de l'Arduino : ${lastReceivedData || 'Aucune donnée reçue de l\'Arduino pour le moment'}`);
});
